...
function action(context = github.context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const defaultLabel = core.getInput('default-label', { required: true });
            ...
            if (issueToLink != null) {
                yield octokit.issues.createComment(Object.assign(Object.assign({}, context.repo), { number: context.payload.pull_request.number, body: "Issue: " + issueToLink }));
            }
        }
        catch (error) {
...
function getLabelsToAdd(config, branchName) {
    ...
    for (const label in config) {
        ...
        const matches = matcher_1.default([branchName], patterns);
        if (matches.length > 0) {
...
function getIssueToLink(branchName) {
